    ...
    public static class TeacherBuilder {
        ...
        public Teacher build() {
            ...
            if (certifications != null) {
                java.util.List<com.heronix.model.domain.SubjectCertification> subjectCerts =
                    new java.util.ArrayList<>();
                for (String cert : certifications) {
                    com.heronix.model.domain.SubjectCertification subjectCert =
                        new com.heronix.model.domain.SubjectCertification();
