...
class OptimizationServiceImplTest {
    ...
    void testCountConstraintViolations_WithMatchingConflicts_ShouldReturnCount() {
        ...
        conflict1.setConflictType(com.heronix.model.enums.ConflictType.TEACHER_OVERLOAD);
        conflict1.setIsResolved(false);
        conflict1.setIsIgnored(false);

        Conflict conflict2 = new Conflict();
        conflict2.setConflictType(com.heronix.model.enums.ConflictType.TEACHER_OVERLOAD);
    ...
    void testCountConstraintViolations_WithResolvedConflicts_ShouldNotCount() {
        ...
        conflict.setConflictType(com.heronix.model.enums.ConflictType.TEACHER_OVERLOAD);
    ...
    void testGetAllViolations_WithConflicts_ShouldReturnViolations() {
        Conflict conflict = new Conflict();
        conflict.setConflictType(com.heronix.model.enums.ConflictType.ROOM_DOUBLE_BOOKING);
    ...
    void testGetAllViolations_ShouldSkipResolvedConflicts() {
        ...
        resolved.setConflictType(com.heronix.model.enums.ConflictType.ROOM_DOUBLE_BOOKING);
        resolved.setIsResolved(true);
        resolved.setIsIgnored(false);

        Conflict active = new Conflict();
        active.setConflictType(com.heronix.model.enums.ConflictType.TEACHER_OVERLOAD);
