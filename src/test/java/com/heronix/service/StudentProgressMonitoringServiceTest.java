...
public class StudentProgressMonitoringServiceTest {
    ...
    public void setup() {
        ...
        testSchedule.setPeriod(com.heronix.model.enums.SchedulePeriod.YEARLY);
        testSchedule.setScheduleType(com.heronix.model.enums.ScheduleType.TRADITIONAL);
        testSchedule.setStatus(com.heronix.model.enums.ScheduleStatus.DRAFT);
