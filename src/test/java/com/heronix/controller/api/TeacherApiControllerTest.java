...
public class TeacherApiControllerTest {
    ...
    @Autowired
    private com.heronix.repository.GradingCategoryRepository gradingCategoryRepository;
    ...
    public void setup() {
        ...
        testCourse.setCourseType(com.heronix.model.enums.CourseType.REGULAR);
    ...
    private Assignment createTestAssignment() {
        ...
        com.heronix.model.domain.GradingCategory category =
            new com.heronix.model.domain.GradingCategory();
