// Location: src/main/java/com/heronix/util/AuthenticationContext.java
...
public class AuthenticationContext {
    ...
    /**
     * Get current staff ID (User ID serves as staff ID)
    ...
    public static Long getCurrentStaffId() {
        return getCurrentUserId() != null ? getCurrentUserId() : 1L;
    }
}
