...
public class Student {
    ...
    @Column(name = "state_student_id", length = 50)
    ...
    @Column(name = "preferred_first_name", length = 50)
    ...
    /**
     * Family household (for sibling tracking and family discounts)
     * Added: December 23, 2025 - Sibling Enrollment Linking Enhancement
     */
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "family_household_id")
    @ToString.Exclude
    private FamilyHousehold familyHousehold;
    ...
    /**
     * Gender Identity (student's self-identified gender)
     */
    @Column(name = "gender_identity", length = 100)
    ...
    /**
     * Is student Hispanic or Latino? (for federal reporting)
     */
    @Column(name = "is_hispanic_latino")
    ...
    /**
     * Primary language (alias for form compatibility)
     */
    @Column(name = "primary_language", length = 50)
    private String primaryLanguage;

    /**
     * Home language (language spoken at home)
     */
    ...
    /**
     * Country of birth (alias for form compatibility)
     */
    ...
    /**
     * Street address (alias for form compatibility)
     */
    ...
    /**
     * City (alias for form compatibility)
     */
    ...
    /**
     * State (alias for form compatibility)
     */
    ...
    /**
     * ZIP code (alias for form compatibility)
     */
    ...
    /**
     * Mailing street (alias for form compatibility)
     */
    ...
    /**
     * Who the student lives with (primary residence)
     * Values: "Both Parents", "Mother", "Father", "Grandmother", "Grandfather",
     *         "Foster Parents", "Other Relative", "Legal Guardian", "Group Home"
     * Added: December 27, 2025 - Phase 2 Enrollment Enhancement
     */
    @Column(name = "lives_with", length = 100)
    ...
    /**
     * Health insurance subscriber name (policyholder name)
     * Usually parent/guardian name for dependent students
     * Added: December 27, 2025 - Phase 2 Enrollment Enhancement
     */
    @Column(name = "insurance_subscriber_name", length = 200)
    ...
    /**
     * Username of administrator who created this record
     * Added: December 27, 2025 - Audit trail enhancement
     */
    @Column(name = "created_by", length = 100)
    private String createdBy;

    /**
     * Username of administrator who last modified this record
     * Added: December 27, 2025 - Audit trail enhancement
     */
