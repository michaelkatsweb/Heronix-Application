 ...
 * Location: src/main/java/com/heronix/model/domain/ParentGuardian.java
 *
...
public class ParentGuardian {
    ...
    /**
     * Home address (general field for form compatibility)
     */
    ...
    /**
     * Can make educational decisions for student?
     */
    @Column(name = "can_make_educational_decisions")
    private Boolean canMakeEducationalDecisions = true;

    /**
     * Receives school emails?
     */
    @Column(name = "receives_school_emails")
    private Boolean receivesSchoolEmails = true;

    /**
     * Receives emergency alerts?
     */
    @Column(name = "receives_emergency_alerts")
    private Boolean receivesEmergencyAlerts = true;

    /**
     * Receives text notifications?
     */
    @Column(name = "receives_text_notifications")
    private Boolean receivesTextNotifications = false;

    /**
     * Receives email notifications?
     */
    @Column(name = "receives_email_notifications")
    private Boolean receivesEmailNotifications = true;
    ...
    /**
     * Parent portal user account (if parent has portal access)
     */
