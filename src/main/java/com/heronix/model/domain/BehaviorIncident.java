...
public class BehaviorIncident {
    ...
    // Alias for SeverityLevel
    public static final class Severity {
        public static final SeverityLevel MINOR = SeverityLevel.MINOR;
        public static final SeverityLevel MODERATE = SeverityLevel.MODERATE;
        public static final SeverityLevel MAJOR = SeverityLevel.MAJOR;
    }
    ...
    public Teacher getReportingStaff() {
        return reportingTeacher;
    }

    public void setReportingStaff(Teacher teacher) {
        this.reportingTeacher = teacher;
    }

    public String getLocation() {
        return incidentLocation != null ? incidentLocation.name() : null;
    }

    public void setLocation(String location) {
        if (location != null) {
            this.incidentLocation = IncidentLocation.valueOf(location);
        }
    }
    ...
    public void setActionTaken(String action) {
        this.interventionApplied = action;
    }
    ...
    public void setParentContacted(Boolean contacted) {
        this.parentContacted = contacted;
    }

    public Boolean isAdministrativeReferral() {
        return adminReferralRequired;
    }

    public void setAdministrativeReferral(Boolean required) {
        this.adminReferralRequired = required;
    }
