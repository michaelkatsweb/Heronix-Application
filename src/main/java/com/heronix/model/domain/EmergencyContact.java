 ...
 * Location: src/main/java/com/heronix/model/domain/EmergencyContact.java
 *
...
public class EmergencyContact {
    ...
    /**
     * Address (general field for form compatibility)
     */
     ...
     */
    @Column(name = "authorized_for_medical")
    private Boolean authorizedForMedical = false;

    /**
     * Authorized for financial decisions/transactions?
     */
    @Column(name = "authorized_for_financial")
    private Boolean authorizedForFinancial = false;

    /**
     * Authorization notes (details about authorizations)
     */
    @Column(name = "authorization_notes", columnDefinition = "TEXT")
    ...
    /**
     * Emergency instructions specific to this contact
     */
    @Column(name = "emergency_instructions", columnDefinition = "TEXT")
    ...
    /**
     * Has this contact information been verified?
     */
    @Column(name = "verified")
    private Boolean verified = false;

    /**
     * Date when contact information was last verified
     */
