// Location: src/main/java/com/heronix/controller/StudentController.java
...
public class StudentController {
    ...
    private StudentDTO convertToDTO(Student student) {
        return StudentDTO.builder()
                ...
                .livesWith(student.getLivesWith())
                ...
                .insuranceSubscriberName(student.getInsuranceSubscriberName())
