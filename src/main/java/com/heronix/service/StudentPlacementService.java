 ...
 * Location: src/main/java/com/heronix/service/StudentPlacementService.java
 *
...
public class StudentPlacementService {
    ...
    public String getAIRecommendations(Student student) {
        log.warn("AI recommendations feature has been removed (Ollama integration deprecated)");
        return "AI recommendations not available. This feature has been removed. " +
               "Please use rule-based course placement recommendations instead.";
    }
