 ...
 * Location: src/main/java/com/heronix/service/impl/ConflictResolutionSuggestionServiceImpl.java
 *
...
public class ConflictResolutionSuggestionServiceImpl implements ConflictResolutionSuggestionService {
    ...
    public List<ConflictResolutionSuggestion> generateSuggestions(Conflict conflict) {
        ...
        try {
            ...
            // AI enhancement removed (Ollama integration deprecated)
            // Suggestions now rely on rule-based algorithms only
