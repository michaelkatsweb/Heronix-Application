...
public class LocalizationService {
    ...
    private void initializeCommonLocales() {
        ...
        registerLocale(LocaleConfig.builder()
                ...
                .nativeDisplayName("Ελληνικά (Ελλάδα)")
                .active(true)
                .rightToLeft(false)
                .dateFormat(LocaleConfig.DateFormat.MEDIUM)
                .timeFormat(LocaleConfig.TimeFormat.HOUR_24)
        ...
        registerLocale(LocaleConfig.builder()
                ...
                .nativeDisplayName("Italiano (Italia)")
                .active(true)
                .rightToLeft(false)
                .dateFormat(LocaleConfig.DateFormat.MEDIUM)
                .timeFormat(LocaleConfig.TimeFormat.HOUR_24)
        ...
        registerLocale(LocaleConfig.builder()
                ...
                .nativeDisplayName("Polski (Polska)")
                .active(true)
                .rightToLeft(false)
                .dateFormat(LocaleConfig.DateFormat.MEDIUM)
                .timeFormat(LocaleConfig.TimeFormat.HOUR_24)
        ...
        registerLocale(LocaleConfig.builder()
                ...
                .nativeDisplayName("ไทย (ประเทศไทย)")
                .active(true)
                .rightToLeft(false)
                .dateFormat(LocaleConfig.DateFormat.MEDIUM)
                .timeFormat(LocaleConfig.TimeFormat.HOUR_24)
