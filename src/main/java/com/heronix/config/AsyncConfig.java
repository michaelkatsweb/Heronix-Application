...
public class AsyncConfig implements AsyncConfigurer {
    ...
    /**
     * Report generation executor for async report generation
     * Dedicated pool for resource-intensive report operations
     *
    ...
    public Executor reportExecutor() {
        ...
        executor.setMaxPoolSize(10);
        executor.setQueueCapacity(25);
        executor.setThreadNamePrefix("Heronix-Report-");
        ...
        log.info("Report executor initialized: core={}, max={}, queue={}",
                executor.getCorePoolSize(), executor.getMaxPoolSize(), executor.getQueueCapacity());
