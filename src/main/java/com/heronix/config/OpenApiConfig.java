...
public class OpenApiConfig {
    ...
    private List<Tag> apiTags() {
        return Arrays.asList(
            ...
            new Tag()
                .name("Integrations")
                .description("External system integrations (LMS, Google Classroom, Canvas)"),
            new Tag()
                .name("API Keys")
                .description("API key lifecycle management and access control"),
            new Tag()
                .name("Attendance Analytics")
                .description("Attendance analytics, ADA/ADM, and chronic absenteeism"),
            new Tag()
                .name("Behavior Reports")
                .description("Behavior incident tracking and discipline analytics"),
            new Tag()
                .name("Assignment Reports")
                .description("Assignment and grade reporting with standards-based grading"),
            new Tag()
