 ...
 * Location: src/main/java/com/heronix/config/SecurityConfig.java
 *
...
public class SecurityConfig {
    ...
    /**
     * Production security configuration has been moved to ProductionSecurityConfig.java
     * for better organization and comprehensive security settings.
     *
     * See: src/main/java/com/heronix/config/ProductionSecurityConfig.java
     *
