...
public class SubstituteAssignmentDialogController {
     ...
     */
    private com.heronix.model.enums.AbsenceReason mapReasonStringToEnum(String reason) {
        if (reason == null) {
        ...
        switch (reason) {
            ...
            case "Medical Appointment":
                return com.heronix.model.enums.AbsenceReason.SICK_LEAVE; // Map medical appointment to sick leave
            case "Jury Duty":
